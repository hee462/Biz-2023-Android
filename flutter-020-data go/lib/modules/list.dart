...
class BusStationListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final busStaitonProvider =
        Provider.of<BusStaitonProvider>(context, listen: false);
    busStaitonProvider.loadStation();
    return Scaffold(
        appBar: AppBar(title: const Text("버스정류장 정보")),
        body: Consumer<BusStaitonProvider>(builder: (context, provider, child) {
