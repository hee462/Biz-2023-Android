...
/// with : 현재는 한개의 클래스를 상속받지만, ChangeNotifier가 자체적으로 상속받았던 클래스, 인터페이스를 모두 상속받기 (상속범위 넓음)
class ThemeController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  // ThemeMode 클래스를 사용한 객체 선언
  // flutter에서 material3의 theme를 쉽게 변경할 수 있도록 미리 준비해둔 클래스
  late ThemeMode _themeMode; // private 변수 선언
  ThemeMode get themeMode =>
      _themeMode; // private 변수를 외부에서 참조할 수 있는 getter 함수 선언
