...
class TimerViewModel extends ChangeNotifier {
  ...
  /// static(프로젝트 start 되면 자동 객체 생성)에 비해서 필요한 경우만 객체를 한번 생성하여
  /// 재활용 한다는 의미에서 static에 대하여 메모리 효율성을 기대 할 수 있다.
  ...
  Future<int> getTimer() async {
    // 이 클래스에서 만들어진 _prefs 객체를 private으로 사용하기 위하여 요구하기
    final SharedPreferences prefs = await _prefs;
    // localStroage(SP)에서 TIMER 라는 이름으로 변수가 저장되어 있으면
